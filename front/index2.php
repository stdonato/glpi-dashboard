                        ...
                        <div class="left-sidebar">
                            <div class="sidebar-holder">
                                ...
                                <ul class="nav nav-list">
                                    ...
                                    <li class=' '>                                    
                                    <a href='#' onclick="window.open('<?php echo $CFG_GLPI['url_base']; ?>/plugins/dashboard/front/graficos/graf_tech.php?con=1','iframe1'); scrollWin();" target="iframe1" data-original-title='My Dashboard'>
                                    ...
                                    <a class='dropdown' onClick='return false;' href='#' data-original-title='Relatórios'>
                                       ...
                                       <li class=' '>
                                            <a href='#' onclick="window.open('./reports/rel_slas.php','iframe1'); scrollWin();" data-original-title=' SLAs'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('SLA'); ?> </span>
                                            </a>
                                        </li>
                                         <li class=' '>                                         
                                ...
                                <li class='submenu'>
                                    ...
                                    <ul  class="animated fadeInDown">
                                        ...
                                        <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/entidades.php','iframe1'); scrollWin();"  data-original-title=' Entidades'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('Entity','dashboard'); ?></span>
                                            </a>
                                        </li>
                                        <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/categorias.php','iframe1'); scrollWin();"  data-original-title=' Categorias' >
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('Category'); ?></span>
                                            </a>
                                        </li>
                                          <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/grupos.php','iframe1'); scrollWin();" data-original-title=' Grupos'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('Group','dashboard'); ?></span>
                                            </a>
                                        </li>
                                        <li class='menu_chart'>
	                                            <a href='#' onclick="window.open('./graficos/local.php','iframe1'); scrollWin();" data-original-title=' Localização'>
	                                                <i class="fa fa-angle-right"></i>
	                                                <span class='hidden-minibar'> <?php echo __('Location'); ?></span>
	                                            </a>
                                        </li>
                                        <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/ativos.php','iframe1'); scrollWin();" data-original-title=' Ativos'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('Assets'); ?></span>
                                            </a>
                                        </li>
                                         <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/satisfacao.php','iframe1'); scrollWin();" data-original-title=' Satisfação'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('Satisfaction','dashboard'); ?></span>
                                            </a>
                                        </li>
                                        <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/geral_mes.php','iframe1'); scrollWin();" data-original-title=' por Data'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('by Date','dashboard'); ?></span>
                                            </a>
                                        </li>
								 					 <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/graf_tecnico.php','iframe1'); scrollWin();" data-original-title=' por Técnico'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('by Technician','dashboard'); ?></span>
                                            </a>
                                        </li>
                                         <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/graf_usuario.php','iframe1'); scrollWin();" data-original-title=' por Usuário'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('by Requester','dashboard'); ?></span>
                                            </a>
                                        </li>
  													 <li class=' '>
                                            <a href='#' onclick="window.open('./graficos/graf_entidade.php','iframe1'); scrollWin();" data-original-title=' por Entidade'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('by Entity','dashboard'); ?></span>
                                            </a>
                                        </li>
                                        <li class=' '>
                                             <a href='#' onclick="window.open('./graficos/graf_categoria.php','iframe1'); scrollWin();" data-original-title=' por Categoria'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('by Category','dashboard'); ?></span>
                                            </a>
                                        </li>
													 <li class=' '>
                                             <a href='#' onclick="window.open('./graficos/graf_grupo.php','iframe1'); scrollWin();" data-original-title=' por Grupo'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('by Group','dashboard'); ?></span>
                                            </a>
                                        </li>
                                        <li class=' '>
                                             <a href='#' onclick="window.open('./graficos/graf_localidade.php','iframe1'); scrollWin();" data-original-title=' por Localidade'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('by Location','dashboard'); ?></span>
                                            </a>
                                        </li>
                                       <li class=' '>
                                             <a href='#' onclick="window.open('./graficos/slas.php','iframe1'); scrollWin();" data-original-title=' por SLA'>
                                                <i class="fa fa-angle-right"></i>
                                                <span class='hidden-minibar'> <?php echo __('by SLA','dashboard'); ?></span>
                                            </a>
                                        </li>
                                       <li class=' '>
                                             <a href='#' onclick="window.open('./graficos/times.php','iframe1'); scrollWin();" data-original-title=' por Tempo'>
                                                <i class="fa fa-angle-right"></i>
